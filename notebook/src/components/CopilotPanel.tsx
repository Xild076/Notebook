...
export const CopilotPanel: React.FC = () => {
  const { aiProviders, selectedAIProvider, setSelectedAIProvider, activeFile, fileContents, fileStructure, setFileContent, markUnsavedChanges, viewedHistory, toolExecutionMode } = useAppStore();
